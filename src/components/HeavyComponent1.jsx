...
function HeavyComponent1() {
  ...
  return (
    <div style={{ padding: '2rem', background: '#f0f8ff', borderRadius: '8px' }}>
      <h2>🎨 Heavy Component 1</h2>
      <p>This component contains 1000 data items and was loaded lazily.</p>
      <p>Check the Network tab - this component was loaded in a separate chunk!</p>
      ...
      <div style={{ marginTop: '1rem', maxHeight: '200px', overflow: 'auto', background: 'white', padding: '1rem', borderRadius: '4px' }}>
        ...
        {heavyData.slice(0, 20).map(item => (
          <div key={item.id} style={{ padding: '0.25rem', borderBottom: '1px solid #eee' }}>
